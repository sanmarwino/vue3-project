...
<template>
    <section class="relative w-full lg:h-lvh md:h-min " data-aos="zoom-in-up">
        <div class="absolute top-0 inset-x-0 h-64 flex items-start h-full">
            <div class="h-24 w-2/3 bg-gradient-to-br from-[#D4C9BE] blur-2xl invisible opacity-40"></div>
            <div class="h-20 w-3/5 bg-gradient-to-r from-[#123458] opqcity-40 blur-2xl"></div>
        </div>
            ...
            <div class="grid lg:grid-cols-2 gap-10 xl:gap-14 relative pt-24 lg:max-w-none max-w-2xl md:max-w-3xl mx-auto">
                <div class="lg:py-10">
                    <div class="text-center lg:text-left">
                        <h1 class="pt-4 text-white font-bold text-4xl md:text-5xl lg:text-8xl">
                            Hi, I'm <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-gray-500">
                                Marwin
                            </span>😁
                        </h1>
                    </div>
                    <p class="text-gray-300 pt-8 text-center lg:text-left mx-auto max-w-xl font-mono">
                        Hello! I'm Marwin Joseph Medado, but you can call me Win.
                        I love playing basketball and billiards. Passionate about innovation, I bring creative ideas to life through code. I’m constantly exploring new technologies and unlocking the endless possibilities of creative coding.
                    </p>
                    <div class="flex items-center gap-3 pt-9 flex-col sm:flex-row sm:w-max sm:mx-auto lg:mx-0">
                        <button class="px-6 md:px-7 py-3 rounded-full relative group w-full sm:w-max flex justify-center">
                            ...
                            <span class="relative flex items-center justify-center text-white" :href="contact" @click="scrollToSection(contact)">Hire Me</span>
                        </button>
                        ...
                        <div class="absolute h-full z-10 p-2 -translate-y-1/2 top-1/2 lg:right-3 md:right-40 sm:right-16 rounded-full shadow-lg border border-primary w-full sm:w-3/4 md:w-1/2 lg:w-[550px]">
                            ...
                            >
                             <div class="text-center pt-5">
                                <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-gray-500 text-4xl font-bold">FRONT-END WEB DEVELOPER</span>
                             </div>
                        </div>
